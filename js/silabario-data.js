...
const SILABARIO_DATA = [
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 3,  word: "pipo",  syllables: ["pi","po"],  emoji: "🐶" },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      { n: 1,  word: "la la",  syllables: ["la","la"],  emoji: "🎵" },
      { n: 2,  word: "le la",  syllables: ["le","la"],  emoji: "🎵" },
      { n: 3,  word: "li la",  syllables: ["li","la"],  emoji: "🎵" },
      { n: 4,  word: "lo la",  syllables: ["lo","la"],  emoji: "🎵" },
      { n: 5,  word: "lu la",  syllables: ["lu","la"],  emoji: "🎵" },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 2,  word: "memo",    syllables: ["me","mo"],       emoji: "👦" },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 3,  word: "duda",    syllables: ["du","da"],      emoji: "🤔" },
      { n: 4,  word: "dime",    syllables: ["di","me"],      emoji: "🗣️" },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 5,  word: "sopita",  syllables: ["so","pi","ta"],   emoji: "🍲" },
      { n: 6,  word: "sapo",    syllables: ["sa","po"],        emoji: "🐸" },
      { n: 7,  word: "sapito",  syllables: ["sa","pi","to"],   emoji: "🐸" },
      { n: 8,  word: "casa",    syllables: ["ca","sa"],        emoji: "🏠" },
      { n: 9,  word: "casita",  syllables: ["ca","si","ta"],   emoji: "🏠" },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 2,  word: "manita",   syllables: ["ma","ni","ta"],   emoji: "✋" },
      { n: 3,  word: "mono",     syllables: ["mo","no"],        emoji: "🐒" },
      { n: 4,  word: "monito",   syllables: ["mo","ni","to"],   emoji: "🐒" },
      { n: 5,  word: "luna",     syllables: ["lu","na"],        emoji: "🌙" },
      { n: 6,  word: "lunita",   syllables: ["lu","ni","ta"],   emoji: "🌙" },
      { n: 7,  word: "nido",     syllables: ["ni","do"],        emoji: "🪹" },
      { n: 8,  word: "nidito",   syllables: ["ni","di","to"],   emoji: "🪺" },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 8,  word: "mojado",  syllables: ["mo","ja","do"],   emoji: "💧" },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 9,  word: "bonito",  syllables: ["bo","ni","to"],   emoji: "🐟" },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 5,  word: "Jefe",      syllables: ["Je","fe"],         emoji: "👔" },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 10, word: "tobillo",  syllables: ["to","bi","llo"],   emoji: "🦶" },
    ],
    rails: [
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 9,  word: "moño",    syllables: ["mo","ño"],         emoji: "🎀" },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 3,  word: "alto",    syllables: ["al","to"],          emoji: "📏" },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 4,  word: "orgulloso",syllables: ["or","gu","llo","so"], emoji: "😌" },
      { n: 5,  word: "Ernesto",  syllables: ["Er","nes","to"],    emoji: "👦" },
      { n: 6,  word: "carta",    syllables: ["car","ta"],         emoji: "✉️" },
      { n: 7,  word: "tarde",    syllables: ["tar","de"],         emoji: "🌆" },
      { n: 8,  word: "corto",    syllables: ["cor","to"],         emoji: "✂️" },
      { n: 9,  word: "largo",    syllables: ["lar","go"],         emoji: "🐍" },
    ],
    rails: [
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 8,  word: "importante", syllables: ["im","por","tan","te"], emoji: "⭐" },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 3,  word: "peinador",  syllables: ["pei","na","dor"],   emoji: "💇" },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 8,  word: "furioso",  syllables: ["fu","rio","so"],     emoji: "😡" },
    ],
    rails: [
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 5,  word: "suave",    syllables: ["sua","ve"],          emoji: "🪶" },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 12, word: "goloso",   syllables: ["go","lo","so"],      emoji: "🍬" },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 4,  word: "glotón",     syllables: ["glo","tón"],           emoji: "😋" },
      { n: 5,  word: "inglés",     syllables: ["in","glés"],           emoji: "🇬🇧" },
      { n: 6,  word: "iglú",       syllables: ["i","glú"],             emoji: "🏠" },
      { n: 7,  word: "gladiolo",   syllables: ["gla","dio","lo"],      emoji: "🌷" },
      { n: 8,  word: "gloria",     syllables: ["glo","ria"],           emoji: "✨" },
      { n: 9,  word: "glicerina",  syllables: ["gli","ce","ri","na"],  emoji: "🫧" },
      { n: 10, word: "Inglaterra", syllables: ["In","gla","te","rra"], emoji: "🌍" },
    ],
    rails: [
      ...
      { text: "Glo-ria  a-rre-gla  los  gla-dio-los  de  la  i-gle-sia." },
      { text: "La  glo-ria  del  sol  i-lu-mi-na  los  glo-bos  de  co-lo-res." },
    ],
    newWords: ["iglesia", "globo", "regla", "glotón", "inglés", "iglú", "gladiolo"],
    teacherNote: "Nombres: Gladys, Gloria, Glorieta.",
  },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 2,  word: "flaco",     syllables: ["fla","co"],           emoji: "🪶" },
      { n: 3,  word: "flojo",     syllables: ["flo","jo"],           emoji: "😴" },
      { n: 4,  word: "rifle",     syllables: ["ri","fle"],           emoji: "🎯" },
      { n: 5,  word: "inflado",   syllables: ["in","fla","do"],      emoji: "🎈" },
      { n: 6,  word: "flores",    syllables: ["flo","res"],          emoji: "🌸" },
      { n: 7,  word: "flecos",    syllables: ["fle","cos"],          emoji: "🎀" },
      { n: 8,  word: "flauta",    syllables: ["flau","ta"],          emoji: "🎵" },
      { n: 9,  word: "florero",   syllables: ["flo","re","ro"],      emoji: "💐" },
      { n: 10, word: "flamenco",  syllables: ["fla","men","co"],     emoji: "🦩" },
      { n: 11, word: "florida",   syllables: ["flo","ri","da"],      emoji: "🌺" },
      { n: 12, word: "fluido",    syllables: ["flui","do"],          emoji: "💧" },
    ],
    rails: [
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 5,  word: "claro",    syllables: ["cla","ro"],          emoji: "💡" },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 2,  word: "cruda",      syllables: ["cru","da"],            emoji: "🥩" },
      { n: 3,  word: "lacre",      syllables: ["la","cre"],            emoji: "🕯️" },
      ...
      { n: 8,  word: "crisantemo", syllables: ["cri","san","te","mo"], emoji: "🌸" },
      { n: 9,  word: "credo",      syllables: ["cre","do"],            emoji: "📜" },
      { n: 10, word: "crucero",    syllables: ["cru","ce","ro"],       emoji: "🚢" },
      { n: 11, word: "criatura",   syllables: ["cria","tu","ra"],      emoji: "👶" },
      { n: 12, word: "microbus",   syllables: ["mi","cro","bus"],      emoji: "🚌" },
    ],
    rails: [
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 4,  word: "afrecho",    syllables: ["a","fre","cho"],       emoji: "🌾" },
      { n: 5,  word: "azufre",     syllables: ["a","zu","fre"],        emoji: "🫧" },
      { n: 6,  word: "Alfredo",    syllables: ["Al","fre","do"],       emoji: "👦" },
      { n: 7,  word: "frambuesa",  syllables: ["fram","bue","sa"],     emoji: "🍇" },
      { n: 8,  word: "frazada",    syllables: ["fra","za","da"],       emoji: "🛏️" },
      { n: 9,  word: "frontera",   syllables: ["fron","te","ra"],      emoji: "🗺️" },
      { n: 10, word: "Africa",     syllables: ["Á","fri","ca"],        emoji: "🌍" },
      { n: 11, word: "frío",       syllables: ["frí","o"],             emoji: "🥶" },
      { n: 12, word: "freno",      syllables: ["fre","no"],            emoji: "🚗" },
    ],
    rails: [
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 6,  word: "kiwi",      syllables: ["ki","wi"],               emoji: "🥝" },
      { n: 7,  word: "karaoke",   syllables: ["ka","ra","o","ke"],      emoji: "🎤" },
      { n: 8,  word: "koala",     syllables: ["ko","a","la"],           emoji: "🐨" },
      { n: 9,  word: "ketchup",   syllables: ["ket","chup"],            emoji: "🍅" },
      { n: 10, word: "Kelvin",    syllables: ["Kel","vin"],             emoji: "👦" },
    ],
    rails: [
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      ...
      { n: 7,  word: "boxeo",     syllables: ["bo","xe","o"],           emoji: "🥊" },
      { n: 8,  word: "saxofón",   syllables: ["sa","xo","fón"],         emoji: "🎷" },
      { n: 9,  word: "xilófono",  syllables: ["xi","ló","fo","no"],     emoji: "🎵" },
      { n: 10, word: "explosión", syllables: ["ex","plo","sión"],       emoji: "💥" },
      { n: 11, word: "expedición",syllables: ["ex","pe","di","ción"],   emoji: "🗺️" },
      { n: 12, word: "extraño",   syllables: ["ex","tra","ño"],         emoji: "🤔" },
    ],
    rails: [
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    pillar: [
      { n: 1,  word: "pingüino",  syllables: ["pin","güi","no"],    emoji: "🐧" },
      { n: 2,  word: "cigüeña",   syllables: ["ci","güe","ña"],     emoji: "🦢" },
      { n: 3,  word: "vergüenza", syllables: ["ver","güen","za"],   emoji: "😳" },
      { n: 4,  word: "jarro",     syllables: ["ja","rro"],          emoji: "🏺" },
      { n: 5,  word: "jinete",    syllables: ["ji","ne","te"],      emoji: "🏇" },
      { n: 6,  word: "jefe",      syllables: ["je","fe"],           emoji: "👨‍💼" },
      { n: 7,  word: "general",   syllables: ["ge","ne","ral"],     emoji: "🎖️" },
      { n: 8,  word: "gigante",   syllables: ["gi","gan","te"],     emoji: "🏔️" },
      { n: 9,  word: "gelatina",  syllables: ["ge","la","ti","na"], emoji: "🍮" },
      { n: 10, word: "girasol",   syllables: ["gi","ra","sol"],     emoji: "🌻" },
      { n: 11, word: "generoso",  syllables: ["ge","ne","ro","so"], emoji: "🤝" },
      { n: 12, word: "gitano",    syllables: ["gi","ta","no"],      emoji: "🎭" },
    ],
    rails: [
